...
fitting musical length (`1`, `2`, `4`, `8`, `16`, `32`, or `64` bars). New MIDI
and audio items are glued to that length and then source-looped to fill the
block. Existing items are left alone, so overdubs remain editable as separate
items or lanes.
